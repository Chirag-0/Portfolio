    ...
    <main className="h-auto">
       <div className=" text-white  flex flex-col-reverse md:flex md:flex-row lg:flex lg:flex-row w-full h-[100%] sm:h-screen relative">
            <div className="-mb-[20rem] sm:-mb-52 lg:mb-0  -mt-10">
                ...
                <h3 ref={title} className="font-titan flex flex-col text-6xl ml-8 mt-8 md:flex md:flex-col md:whitespace-nowrap lg:flex lg:flex-col md:text-[3.8rem] xl:block lg:text-[4.5rem] md:mt-24 md:ml-20 relative z-30 bottom-0 pb-2  overflow-hidden"> 
