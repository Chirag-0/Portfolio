    ...
    <main className="h-auto">
       <div className=" text-white  flex flex-col-reverse md:flex md:flex-row lg:flex lg:flex-row w-full h-[100%] sm:h-screen xl:h-auto relative">
            <div className="-mb-[20rem] sm:-mb-52 lg:mb-0  -mt-10">
                ...
                Hello, <span>I&apos;m <span className="text-[#E79738] hover:animate-pulse cursor-pointer"> Chirag</span></span> 
                </h3>
                </div>
                <p ref={paragraph} className="ml-8 mt-2 w-[75%] md:ml-20 lg:mt-10 xl:mt-2 md:w-[60%] xl:w-1/2 font-roboto text-[#706E6E] font-bold md:text-[0.9rem] lg:text-[1rem]">
                    <br />
                    I’m a passionate Frontend Developer with a strong foundation in HTML, CSS, JavaScript, React.js, and Next.js.I love building sleek, responsive, and user-friendly web applications that blend functionality with engaging design.
                <br /><br />
                 With a solid foundation in Java, Data Structures, and collaborative tools like Git/GitHub, I focus on building efficient and impactful digital experiences

                </p>

                <button  className="font-roboto bg-[#E79738] text-black font-semibold ml-8 md:ml-20 mt-10 md:mt-8 p-2 rounded-md hover:bg-[#ffb347] transition-all duration-300 ease-in-out"><a ref={btn} href="/ChiragChouhan.pdf" download >Get Resume</a></button>
            </div>
